...
import logoMp from "/lovable-uploads/a487894a-9e40-44a6-a9de-cf5614464e42.png";
            ...
            <div className="flex-1 md:flex-initial">
              ...
              >
                <motion.img 
                  ...
                  className={`h-14 sm:h-16 md:h-20 w-auto object-contain ${!logoLoaded ? 'opacity-0' : 'opacity-100'}`}
                  whileHover={{ rotate: 5 }}
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {navigationItems.map((item, index) => (
                <motion.button
                  ...
                  className="transition-colors relative text-sm lg:text-base font-medium text-slate-50"
                >
                  {item.label}
                </motion.button>
              ))}
